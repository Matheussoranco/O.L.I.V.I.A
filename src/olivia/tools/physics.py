...
CONSTANTS: tuple[Constant, ...] = (
    ...
    Constant(
        "h", "Planck constant", 6.62607015e-34, "J s", ("planck constant", "planck's constant")
    ),
    Constant(
        "hbar",
    ...
    Constant("k_B", "Boltzmann constant", 1.380649e-23, "J/K", ("boltzmann constant", "boltzmann")),
    Constant(
        "N_A",
        "Avogadro constant",
        6.02214076e23,
    ...
    Constant("F", "Faraday constant", 96485.33212, "C/mol", ("faraday constant",)),
    Constant(
        "sigma",
    ...
    Constant("m_n", "neutron mass", 1.67492749804e-27, "kg", ("neutron mass", "mass of neutron")),
    Constant(
        "g",
    ...
    Constant("a_0", "Bohr radius", 5.29177210903e-11, "m", ("bohr radius",)),
    Constant("Ry", "Rydberg constant", 10973731.568160, "m^-1", ("rydberg constant",)),
    Constant(
        "atm",
        "standard atmosphere",
        101325.0,
